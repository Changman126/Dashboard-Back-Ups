...
CREATE TABLE AS ahemphill.viable_user_enroll AS
...
(
	...
	JOIN
		(
			...
			AND 
				a.first_enrollment_time >= '2016-04-01'
		) c
	ON
		a.user_id = c.user_id
	AND
		a.user_account_creation_time >= '2016-04-01'
...
ON
	a.user_id = b.user_id
AND
	b.first_enrollment_time >= '2016-04-01'
GROUP BY
	course_id,
	engagement_level;
...
(
	...
	ON
		a.user_id = b.user_id
	AND 
		b.first_verified_enrollment_time >= '2016-04-01'
	AND 

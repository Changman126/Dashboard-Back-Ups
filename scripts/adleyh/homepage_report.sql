...
SELECT
	...
	WHEN date BETWEEN '2016-11-02' AND '2016-11-07' THEN '11/02-11/07'
	WHEN date BETWEEN '2016-11-10' AND '2016-11-13' THEN '11/10-11/13'
	END AS week,
	CASE
	WHEN
...
DROP TABLE IF EXISTS ahemphill.homepage_funnel_summarized;
CREATE TABLE ahemphill.homepage_funnel_summarized AS
...
SELECT 
	...
	COUNT(1) AS cnt
FROM 
	ahemphill.homepage_funnel_sequenced 
WHERE 
	week IS NOT NULL 
